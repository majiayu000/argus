"""Complete, drift-aware GitHub review-thread collection."""
...
def collect_review_threads(
    ...
    """Collect every review-thread page and reject malformed or drifting data."""
    ...
    for _page in range(1000):
        ...
        for node in nodes:
            ...
            if thread_id in seen_thread_ids:
                raise EvidenceError("review-thread pagination returned a duplicate thread id")
